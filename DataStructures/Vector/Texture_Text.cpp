...
void Texture_Text::RenderValue( SDL_Renderer* renderer, int32_t value )
{
	std::stringstream  ss;
	ss << value;
	RenderText_Solid( renderer, ss.str() );
...
/*
void Texture_Text::RenderValue( SDL_Renderer* renderer, double value )
{
	std::stringstream  ss;
	ss << value;
	RenderText_Solid( renderer, ss.str() );
